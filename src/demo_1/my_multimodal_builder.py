...
def build_qwen2_5_vl_engine(args):
    ...
    from transformers.models.qwen2_5_vl.modeling_qwen2_5_vl import (
        ...
        Qwen2_5_VLVisionAttention, Qwen2_5_VLVisionSdpaAttention, Qwen2_5_VisionRotaryEmbedding)
    ...
    class Qwen2_5_VisionTransformerPretrainedModelOpt(Qwen2_5_VisionTransformerPretrainedModel):
        ...
        def forward(self, hidden_states: torch.Tensor,
            ...
            # grid_thw = torch.tensor([[1, torch.sqrt(full_attention_mask.shape[1]).to(torch.int32), torch.sqrt(full_attention_mask.shape[1]).to(torch.int32)]])
            # import pdb;pdb.set_trace()
            # grid_thw = torch.tensor([1, img_hw[0] / self.patch_size, img_hw[1] / self.patch_size])
    ...
    import pdb;pdb.set_trace()
    # window_index = window_index.repeat(4)
    window_index = window_index.to(torch.int32)
    rotary_pos_emb = rotary_pos_emb.to(torch.float16)
