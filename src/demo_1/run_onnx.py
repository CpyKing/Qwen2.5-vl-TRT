...
rotary_pos_emb = torch.load('rotary_pos_emb.pt').cpu().to(torch.float16).numpy()
full_attention_mask = torch.load('full_attention_mask.pt').cpu().to(torch.float16).numpy()
window_attention_mask = torch.load('window_attention_mask.pt').cpu().to(torch.float16).numpy()
