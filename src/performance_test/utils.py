def add_common_args(parser):
    ...
    parser.add_argument('--use_py_session',
                        type=bool,
                        default=False,
                        help='If use_py_session is True, then we will use python session')
    args, remaining_args = parser.parse_known_args()
    parser.add_argument('--llm_engine_dir',
                        type=str,
                        default=os.path.join(args.engine_dir, 'llm'),
                        help='Directory containing visual and LLM TRT engines')
    parser.add_argument('--visual_engine_dir',
                        type=str,
                        default=os.path.join(args.engine_dir, 'vision'),
    ...
    parser.add_argument("--image_path",
                        type=str,
                        nargs='+',
                        default=['/sys/fs/cgroup/zzz_tmp/my_dataset/images/womandog.jpeg',
                                 '/sys/fs/cgroup/zzz_tmp/my_dataset/images/womanbus.jpg'],
